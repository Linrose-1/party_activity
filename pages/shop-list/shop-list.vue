...
<script setup>
// --- 修改开始：修正 import 来源 ---
import { ref, computed, onMounted } from 'vue'; // onMounted 从 'vue' 导入
import { onReachBottom } from '@dcloudio/uni-app'; // onReachBottom 从 '@dcloudio/uni-app' 导入
// --- 修改结束 ---
...
const getStoreList = async () => {
  ...
  try {
    ...
    const { data: result, error } = await request('/app-api/member/store/list', {
      method: 'GET',
      data: params
    });
