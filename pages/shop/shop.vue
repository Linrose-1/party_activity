  ...
  <view class="app">
    ...
    <view class="search-container">
      <view class="search-box">
        ...
        <input class="search-input" type="text" placeholder="搜索聚店名称或关键词" v-model="searchTerm" @input="onSearchInput" />
      </view>
...
import StoreCard from '../../components/StoreCard.vue'; // 根据实际路径调整
...
.search-input {
  ...
  outline: none;
  color: var(--dark-text);
  margin-left: 10rpx; /* 适应 uni-icons */
}
...
.empty-state .uni-icons {
  font-size: 60px; /* 使用 uni-icons 的 size 属性 */
  margin-bottom: 20px;
  color: #ffd8c1;
}
