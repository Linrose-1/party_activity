  ...
  <view class="login-container">
    ...
    <view class="form-wrapper">
      ...
      <view class="form-item">
        ...
        <button v-if="!phoneCode" class="get-phone-btn" open-type="getPhoneNumber" @getphonenumber="getPhoneNumber">
          点击获取微信手机号
        </button>
      ...
      <view class="form-item">
        ...
        <input v-model="realName" class="input" type="text" placeholder="请输入您的真实姓名" placeholder-class="placeholder" />
      </view>
      ...
      <view class="form-item">
        ...
        <input v-model="inviteCode" class="input" type="text" placeholder="请输入邀请码 (选填)" placeholder-class="placeholder" />
      </view>
    </view>
...
const handleLogin = () => {
  if (isLoginDisabled.value) {
    uni.showToast({ title: '请先完善信息并同意协议', icon: 'none' });
    return;
  }
