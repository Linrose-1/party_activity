...
const subPackages = [
  {
    ...
    pages: [
      ...
      {
        path: "participant-detail/participant-detail",
        style: {
          navigationBarTitleText: "参会名单"
        }
      },
      {
      ...
      {
        path: "enterprise-edit/enterprise-edit",
        style: {
          navigationBarTitleText: "创建企业/品牌"
        }
      },
      {
        path: "enterprise-list/enterprise-list",
        style: {
          navigationBarTitleText: "我的企业/品牌"
        }
      },
      {
      ...
      {
        path: "silent-view-trace/silent-view-trace",
        style: {
