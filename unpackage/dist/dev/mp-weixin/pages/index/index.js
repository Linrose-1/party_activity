  ...
  setup(__props) {
    ...
    const getLoginCode = async () => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.vue:119", "✅ 获取 loginCode 成功:", loginCode.value);
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/index.vue:121", "❌ 获取 loginCode 失败", error);
    ...
    const getPhoneNumber = (e) => {
      if (e.detail.code) {
        common_vendor.index.__f__("log", "at pages/index/index.vue:134", "✅ 获取手机号凭证 (phoneCode) 成功:", e.detail.code);
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:141", "❌ 用户拒绝了手机号授权:", e.detail.errMsg);
        common_vendor.index.showToast({
          title: "您拒绝了授权",
          icon: "error"
        });
    ...
    const getUserProfile = () => {
      common_vendor.index.getUserProfile({
        desc: "用于完善会员资料",
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/index/index.vue:156", "✅ 获取用户信息成功:", res.userInfo);
        ...
        fail: (err) => {
          common_vendor.index.__f__("error", "at pages/index/index.vue:164", "❌ 用户拒绝了信息授权:", err);
        }
      });
    };
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        f: common_vendor.o(getUserProfile)
      } : {
        g: userInfo.value.avatarUrl,
        h: common_vendor.t(userInfo.value.nickName)
      }, {
        i: common_vendor.p({
