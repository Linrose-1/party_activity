  ...
  setup(__props) {
    ...
    const checkUserVerificationStatus = async () => {
      ...
      if (!error && data) {
        ...
        common_vendor.index.__f__("log", "at pages/active-publish/active-publish.vue:212", "用户实名状态:", isUserVerified.value);
      } else {
        isUserVerified.value = false;
        common_vendor.index.__f__("log", "at pages/active-publish/active-publish.vue:216", "获取用户信息失败，无法确认实名状态。");
      }
    };
    const goToAuthPage = () => {
    ...
    const getActiveType = async () => {
      ...
      common_vendor.index.__f__("log", "at pages/active-publish/active-publish.vue:279", "getActiveType result:", result);
      ...
      common_vendor.index.__f__("log", "at pages/active-publish/active-publish.vue:284", "tagOptions updated:", tagOptions.value);
      if (result.error) {
        common_vendor.index.__f__("log", "at pages/active-publish/active-publish.vue:287", "请求失败:", result.error);
      }
    };
      ...
      common_vendor.index.chooseImage({
        ...
        success: async (res) => {
          ...
          if (result.data) {
            ...
            common_vendor.index.__f__("error", "at pages/active-publish/active-publish.vue:357", "上传失败:", result.error);
            common_vendor.index.showToast({
