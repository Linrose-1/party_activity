  ...
  setup(__props) {
    ...
    const getFavorites = async (isRefresh = false) => {
      ...
      try {
        ...
        common_vendor.index.__f__("log", "at packages/my-collection/my-collection.vue:233", `获取收藏的${isActivityTab ? "聚会" : "商机"}:`, result);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-7ef3bb91"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/packages/my-collection/my-collection.js.map
