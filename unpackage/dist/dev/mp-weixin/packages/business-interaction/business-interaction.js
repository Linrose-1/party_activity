...
const _sfc_main = {
  __name: "business-interaction",
  setup(__props) {
    const CommentApi = {
      /** 获取评论分页列表 */
      getCommentPage: (params) => utils_request.request("/app-api/member/comment/my-page-by-target-type", {
        method: "GET",
        data: params
      })
    };
    ...
    const fetchList = async (isRefresh = false) => {
      ...
      try {
        ...
        const {
          data,
          error
        } = await CommentApi.getCommentPage(params);
        if (!error && data) {
        ...
        loadingStatus.value = "more";
        common_vendor.index.__f__("error", "at packages/business-interaction/business-interaction.vue:201", "获取评论列表失败:", e);
      }
      if (isRefresh) {
      ...
      return common_vendor.e({
        ...
        b: common_vendor.f(commentList.value, (item, k0, i0) => {
          ...
          return common_vendor.e({
            ...
            q: common_vendor.f(item.childrenList, (child, k1, i1) => {
              var _a2, _b2;
              return {
            ...
            r: "d453ca9d-4-" + i0,
            s: "d453ca9d-5-" + i0,
            t: common_vendor.o(($event) => handleReply(item), item.id),
            v: item.id
          });
        }),
        c: common_vendor.p({
        ...
        g: commentList.value.length > 0 || loadingStatus.value === "loading"
      }, commentList.value.length > 0 || loadingStatus.value === "loading" ? {
        h: common_vendor.p({
          status: loadingStatus.value
        })
      } : {}, {
        i: commentList.value.length === 0 && loadingStatus.value === "noMore"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-d453ca9d"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/packages/business-interaction/business-interaction.js.map
