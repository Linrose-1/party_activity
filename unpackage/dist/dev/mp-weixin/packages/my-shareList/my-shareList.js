...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const fetchList = async (isRefresh = false) => {
      ...
      try {
        common_vendor.index.__f__("log", "at packages/my-shareList/my-shareList.vue:119", "--- 发起请求，参数为：", params);
        const {
          data,
          error
        ...
        common_vendor.index.__f__("error", "at packages/my-shareList/my-shareList.vue:145", "请求异常:", e);
        loadStatus.value = "more";
      } finally {
        if (isRefresh)
      ...
      return common_vendor.e({
        ...
        f: common_vendor.f(friendList.value, (friend, k0, i0) => {
          return common_vendor.e({
            ...
            b: common_vendor.t(friend.nickname || friend.realName || "匿名商友"),
            ...
            h: "d52d6798-1-" + i0,
            i: common_vendor.t(friend.companyName || "暂未设置公司信息"),
            j: friend.followTime
          }, friend.followTime ? {
            k: common_vendor.t(formatTimestamp(friend.followTime))
          } : {}, {
            l: common_vendor.t(friend.followFlag === 1 ? "已关注" : "+ 关注"),
            m: friend.followFlag === 1 ? 1 : "",
            n: common_vendor.o(($event) => handleFollowAction(friend), friend.id),
            o: friend.id,
